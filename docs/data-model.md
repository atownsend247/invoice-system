...
seventeen entries: the flattened baseline (2026-09-16), migration 2 (added `tax_rate`
...
the `Registrar` row below), and migration 17 (added `expenses.expense_date`
...
edits to any of these seventeen.
